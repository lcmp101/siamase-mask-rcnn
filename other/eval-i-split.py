...
coco_test_object = test_dataset.load_coco(COCO_DATA, subset="val", year="26", return_coco=True)
...
train_classes = np.array(range(1,5))[np.array([i not in one_shot_classes for i in range(1,5)])]
